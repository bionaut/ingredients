...
$templateCache.put("app/modules/iForm/components/button/button.template.html","<button x-id=\"{{xId}}\" ng-class=\"{fill: fill, small: small, disabled: iDisabled}\" class=\"i-button\" name=\"{{name}}\" type=\"{{type || \'button\'}}\">{{title}}</button>");
